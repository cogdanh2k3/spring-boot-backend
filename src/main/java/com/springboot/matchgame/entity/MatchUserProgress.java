...
@Entity
@Table(name = "match_user_progress")
public class MatchUserProgress {
    @Id
    ...
    // Constructors
    public MatchUserProgress() {}

    public MatchUserProgress(String username, String levelId, Boolean isCompleted) {
