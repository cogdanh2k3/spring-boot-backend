...
@Entity
@Table(name = "matchgame_user_progress")
public class MatchGameUserProgress {
    @Id
    ...
    // Constructors
    public MatchGameUserProgress() {}

    public MatchGameUserProgress(String username, String levelId, Boolean isCompleted) {
